  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.46\textwidth}
      \begin{exampleblock}{Answer}
        \small
        At an \textbf{18\,FPS} budget the extra 4.5\,ms costs about
        \textbf{1.5\,FPS} --- P2 pays for itself. At a 30\,FPS target it would
        not. \textbf{The frame-rate requirement decides, not the mAP table.}
      \end{exampleblock}
    \end{column}
  \end{columns}
\end{frame}
